...
<div class="main">
    <ul>
      <ul class="list">
        <li class="logo"><a href="travel home page.html"><img src="earth-globe.png" alt="Logo" style="width:36px;height:36px"></a></li>
        <div class="search">
  ...
  <form from="myForm" action ="save.php" method="POST">
    ...
    <div class="login-box">
      ...
      <div class="textbox">
        <input type="text" placeholder="First Name" id="fname" name="fname" value="" required>  
      </div>

      <div class="textbox">
        <input type="text" placeholder="Middle Name" id="mname" name="mname" value="" required>  
      </div>

      <div class="textbox">
        <input type="text" placeholder="Last Name" id="lname" name="lname" value="" required>  
      </div>

           <div class="textbox">
            <input type="text" placeholder="Gender" id="gender" name="gender" value="" required>  
            </div>
     ...
     <div class="textbox">
      ...
      <div class="textbox">
      <input type="text" placeholder="Country" id="country" name="country" value="" required>
    </div>
    <div class="textbox">
      <input type="text" placeholder="State" id="state" name="state" value="" required>
    </div>
    <div class="textbox">
      <input type="text" placeholder="City" id="city" name="city" value="" required>
    </div>
    <div class="textbox">
      <input type="text" placeholder="Pincode" id="pincode" name="pincode" value="" required onkeypress="return /[0-9]/i.test(event.key)" maxlength="6" pattern="([0-9]){6,}">
    </div>
